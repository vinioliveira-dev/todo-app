...
const todosAddNewTodoNotificationReaction = (action_s, store) => {
    if (!store) {
    ...
    const reaction_s = add_todo_action_s
        .map(() => console.log('new to-do added'));

    return reaction_s;
};

export {
    todosAddNewTodoNotificationReaction
};